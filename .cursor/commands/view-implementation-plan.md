...
4. Endpoint Description:
   ...
   We just need to reroute to /plan, /map or /login based on the clicked button and user's login state.
   </endpoint_description>
...
1. For each input section (PRD, User Stories, Endpoint Description, Tech Stack):
