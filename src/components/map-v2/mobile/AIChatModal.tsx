...
export function AIChatModal({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header with context */}
        <MobileChatHeader onClose={onClose} selectedPlace={selectedPlace} />
  ...
  return (
    <div className={`flex ${isUser ? "justify-end" : "justify-start"}`}>
      <div className={`max-w-[85%] space-y-3 ${isUser ? "items-end" : "items-start"}`}>
        ...
        <div className={`rounded-2xl px-5 py-3.5 ${isUser ? "bg-blue-600 text-white" : "bg-gray-100 text-gray-900"}`}>
