...
export default function PlannedItem({ item, category, onRemove, onClick }: PlannedItemProps) {
  ...
  const photoUrl = photo?.photoReference ? getPhotoUrl(photo.photoReference, 200) : undefined;
