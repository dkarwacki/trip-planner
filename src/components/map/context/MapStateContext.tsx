...
import { plannedPlacesFromDAOs, tripPlaceDTOsToPlaceDAOs } from "@/lib/map/tripMappers";
  ...
  useEffect(() => {
    ...
    async function loadTripData() {
      try {
        ...
        // Focus on first place if navigated from plan (tripId or conversationId provided) and places exist
